...
KDS_ELECTRON_DIR="$ROOT_DIR/electron_apps/kds"
NEXT_OUTPUT_DIR="$KDS_ELECTRON_DIR/src"
...
mkdir -p "$KDS_ELECTRON_DIR/resources/sounds"
if [ -d "public/sounds" ]; then
  cp -r public/sounds/* "$KDS_ELECTRON_DIR/resources/sounds/"
fi
