        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border">
              <th className="text-left py-2 text-muted-foreground font-medium">{t("warehouseStock.warehouse")}</th>
              <th className="text-right py-2 text-muted-foreground font-medium">{t("warehouseStock.value")}</th>
            </tr>
          </thead>
