                  ...
                  <td className="px-3 py-2">
                    <div className="flex items-center gap-1" style={{ marginLeft: `${cat.depth * 2}rem` }}>
                      ...
                      <div className={`flex items-center gap-2 ${cat.hasChildren ? "cursor-pointer" : ""}`}
                        ...
                        <span className={`font-medium ${cat.depth === 0 ? "text-foreground" : "text-foreground"}`}>
                          {cat.name}
                        </span>
                      </div>
                    </div>
                  ...
                  <td className="px-3 py-2 text-right">
                    <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button onClick={() => openAddSubcategory(cat)}
                        className="flex items-center gap-1 text-xs font-medium text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-900/30 px-2 py-1 rounded-md transition-all dark:text-emerald-400"
                        title={t("addSubTitle")}>
                        <Plus size={13} /> {t("addSub")}
                      </button>
                      <button onClick={() => { setSelectedCategoryId(cat.id); setActiveTab("items"); }}
                        className="flex items-center gap-1 text-xs font-medium text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/30 px-2 py-1 rounded-md transition-all dark:text-blue-400">
