        ...
        <table className="w-full text-sm">
          <thead className="border-b border-border bg-muted border-border">
            <tr>
              ...
              <th className="text-left px-3 py-2 text-xs font-semibold text-muted-foreground tracking-widerdark:text-muted-foreground">{t("colContact")}</th>
              <th className="text-left px-3 py-2 text-xs font-semibold text-muted-foreground tracking-widerdark:text-muted-foreground">{t("colTel")}</th>
              <th className="text-left px-3 py-2 text-xs font-semibold text-muted-foreground tracking-widerdark:text-muted-foreground">{t("colEmail")}</th>
