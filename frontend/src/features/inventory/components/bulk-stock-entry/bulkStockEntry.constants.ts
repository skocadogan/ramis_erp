...
export const bulkStockEntryCellClass =
  "h-8 w-full rounded-md border border-border bg-white px-2 text-xs outline-none focus:ring-1 focus:ring-blue-500/30 border-input bg-muted text-foreground"

export const bulkStockEntryThClass =
