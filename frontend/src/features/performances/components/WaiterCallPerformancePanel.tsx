    ...
    return (
        <div className="flex h-full min-h-0 flex-col gap-4">
            ...
            <div className="grid min-h-0 flex-1 grid-cols-1 gap-4 lg:grid-cols-2">
                ...
                {/* Sağ: grafikler */}
                <div className="rounded-xl border border-border bg-white dark:bg-slate-900 flex flex-col min-h-[320px] lg:min-h-0">
                    <div className="border-b border-border px-4 py-2.5 text-sm font-ui-semibold flex items-center gap-2">
                        <BarChart3 size={16} />
