    ...
    <>
      <div className="mb-4 shrink-0">
        ...
        <textarea
          ...
          rows={2}
          className="w-full resize-none rounded-xl border /80 /50 px-3 py-2 text-sm text-foreground outline-none focus:border-blue-500 focus:bg-background focus:ring-2 focus:ring-blue-500/15 transition-all border-border bg-muted/40 dark:focus:border-blue-400 dark:focus:ring-blue-400/15"
        />
      </div>

      <div className="mt-auto shrink-0 border-t pt-5 border-border bg-card">
