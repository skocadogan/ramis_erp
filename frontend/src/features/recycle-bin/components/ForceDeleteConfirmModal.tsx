        ...
        <div className="p-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="mt-4">
                <p className="text-xs font-ui-semibold text-muted-foreground uppercase tracking-wide mb-2">
          ...
          <DialogFooter className="mt-8 flex gap-3 sm:gap-0">
            ...
            <Button
              ...
              className="flex-1 h-11 rounded-xl font-ui-bold bg-red-700 hover:bg-red-800 text-white shadow-lg shadow-red-500/20"
            >
