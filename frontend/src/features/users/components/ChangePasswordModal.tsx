...
const input = "w-full px-3 py-2  border border-border rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all bg-muted border-input text-foreground"
    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-[60] p-4" onClick={onClose}>
      <div className="rounded-lg border border-border w-full max-w-md shadow-lg bg-card border-border" onClick={e => e.stopPropagation()}>
        <div className="flex items-center justify-between px-6 pt-5 pb-2">
          ...
          <button onClick={onClose} className="p-1.5 rounded-md text-muted-foreground hover: dark:hover:">
            <X size={16} />
          </button>
        </div>
        ...
        <div className="px-6 pb-6 space-y-3">
          ...
          <div className="flex justify-end gap-2 pt-2">
            <button onClick={onClose} className="px-4 py-1.5 text-sm font-medium hover: rounded-md text-muted-foreground dark:hover:">{t("cancel")}</button>
